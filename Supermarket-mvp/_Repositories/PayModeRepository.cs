    ...
    internal class PayModeRepository : BaseRepository, IPayModeRepository
    {
        ...
        public void Add(PayModeModel payModeModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.Parameters.AddWithValue("@name",
                 SqlDbType.NVarChar).Value = payModeModel.Name;
                command.Parameters.AddWithValue("@observation", SqlDbType.NVarChar).Value = payModeModel.Observation;
        ...
        public void Edit(PayModeModel payModeModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                SqlDbType.NVarChar).Value = payModeModel.Name;
                command.Parameters.AddWithValue("@observation", SqlDbType.NVarChar).Value = payModeModel.Observation;
                command.Parameters.AddWithValue("@id", SqlDbType.Int).Value = payModeModel.Id;
                command.ExecuteNonQuery();
            }
        }
